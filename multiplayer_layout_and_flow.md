...
> For core game rules, ranking, leagues, and cosmetics see `multiplayerthoughts.md`.
...
This document covers the UI and flow layer of multiplayer. Game rules and ranking live in `multiplayerthoughts.md`.
